...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wide",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-burgundy-light shadow-elegant hover:shadow-elegant-md",
        ...
        hero: "bg-accent text-accent-foreground hover:bg-gold-light font-semibold shadow-elegant-md hover:shadow-elegant-lg transform hover:-translate-y-0.5",
        heroOutline: "border-2 border-cream bg-transparent text-cream hover:bg-cream hover:text-primary font-semibold",
      },
      size: {
